...
import com.example.demowork1.util.AdbUtil
...
class AnnotationTestActivity : AppCompatActivity() {
    ...
    private lateinit var btnAdbShell:Button
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnAdbShell = findViewById(R.id.btn_adb_cmd)
        btnAdbShell.setOnClickListener {
